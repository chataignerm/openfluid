   ...
   m_MetaPackInfo(MetaPackInfo)
{
  ...
  mp_EmptyCartImage->setPixmap(QPixmap(QString::fromStdString(openfluid::base::RuntimeEnvironment::getInstance()->getAppResourceFilePath("openfluid-market-client","shopping_cart.png"))));
  mp_FullCartImage->setPixmap(QPixmap(QString::fromStdString(openfluid::base::RuntimeEnvironment::getInstance()->getAppResourceFilePath("openfluid-market-client","shopping_cart_full.png"))));
